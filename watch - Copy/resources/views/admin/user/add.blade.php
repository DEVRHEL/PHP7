...
@section('content')
    <div class="widget-box">
        ...
        <div class="widget-content nopadding">
            <form action="{!! route('admin.user.postAdd') !!}" method="post" enctype="multipart/form-data" class="form-horizontal">
                <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                <div class="control-group">
                    <label class="control-label">Username</label>
                    <div class="controls">
                        <input type="text" name="txtUsername" class="span11" placeholder="Please Enter Username" value="{!! old('txtUsername') !!}"/>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="txtEmail" class="span11" placeholder="Please Enter Email" value="{!! old('txtEmail') !!}" />
                    </div>
                </div>
                <div class="control-group">
